...
This repository contains the BahTech#16041 FTC SDK for the Ultimate Goal (2020-2021) competition season.
...
This is a private SDK and should be used only with our team, we used as source the original FTC app that you can find [here](https://github.com/FIRST-Tech-Challenge/FtcRobotController)
