...
@Autonomous (name = "CVWebcam", group = "CV")
public class CVWebcam extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        WebcamName cameraName = hardwareMap.get(WebcamName.class, "webcam");
        final OpenCvCamera camera = OpenCvCameraFactory.getInstance().createWebcam(cameraName, cameraMonitorViewId);
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Threshold", pipeline.getAnalysis()); //Values to analysis the ring quantitie
            telemetry.addData("Rings", pipeline.position); // The number of ring in the stack
   ...
   /**/ public static class StackDetectorSamplePipeline extends OpenCvPipeline
    {
        ...
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(120,98); //x = 181, y = 89
